...
public class MessageConstants {
    ...
    public static final String INVALID_ID = "Employee ID must be a positive integer.";
    ...
    public static final String EMPLOYEE_NOT_FOUND = "No employee found with the given ID.";
